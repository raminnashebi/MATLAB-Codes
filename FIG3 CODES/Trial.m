...
% For first scenario (R0=2.87)
Transmission_rate1=0.1672;% Transmission rate inside household
Transmission_rate2=0.1672;% Transmission rate outside household (workplace and social environment)

% For second scenario (R0=2.87) with random network
Transmission_rate1=0.1672;% Transmission rate inside household
Transmission_rate2=0.1672;% Transmission rate outside household (workplace and social environment)

% For third scenario (R0=1)with random network
Transmission_rate1=0.0214;% Transmission rate inside household
Transmission_rate2=0.0214;% Transmission rate outside household (workplace and social environment)

% For 4th scenario (R0=1)with random network
Transmission_rate1=0.0214;% Transmission rate inside household
Transmission_rate2=0.0214;% Transmission rate outside household (workplace and social environment)


% For 5th scenario (R0=1 and 88% reduction applied to outside transmission rate)
Transmission_rate1=0.1672;% Transmission rate inside household
Transmission_rate2=0.0165;% Transmission rate outside household (workplace and social environment)
...
for i=1:500 % starting simulation for 500 times
    ...
    [tem1,tem2,tem3,tem4,tem5,tem6,tem7,tem8]= main_enes_v_tunc_Mnew_parfor(M,granularity,le,la,lp,ls,a1,b1,b2);
